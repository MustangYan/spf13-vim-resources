...
" General {
    ...
    set timeoutlen=2500         " 这里设置了当对键进行映射的时候,允许超时2.5秒的时间
...
" Vim UI {
    ...
    if has('statusline')
        ...
        set statusline+=\ [%{EchoFuncGetStatusLine()}]"加入echofunc插件的显示
    endif
...
" Plugins {
    ...
    " Ctags {
    set tags=./tags;/,~/.vimtags,~/yanweixin/rcnn/py-faster-rcnn-master_CPU/tags,/usr/include/tags
    ...
    autocmd BufReadPost *.cpp,*.h,*.c,*.hpp,*.py,*.sh,*.cc,*.cu,*.cxx call tagbar#autoopen()
